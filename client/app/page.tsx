    ...
    <div className="flex h-screen">
      <div className="w-[60%] h-full flex flex-col items-center justify-center">
        <div className="prose text-justify">
          ...
          <h2 className="mt-5 transform transition duration-500 ease-in-out hover:scale-110">
            What we offer:
          </h2>
          <ul className="list-inside list-none text-xl space-y-4">
            <li className="transform transition duration-500 ease-in-out hover:scale-110">
          ...
          <p className="mt-5 text-xl transform transition duration-500 ease-in-out hover:scale-110">
        ...
        <p className="mt-2 transform transition duration-500 ease-in-out hover:scale-110">
          Already registered?
          <Link href="/login">
      ...
      <div className="w-2/5 h-full flex items-center justify-center mr-10">
        <div className="card bg-base-200 shadow-xl w-[80%] h-[60%] rounded-2xl transform transition duration-500 ease-in-out hover:scale-110">
          <img
            src="designer.svg"
            alt="designer"
